...
const translations = {
  en: {
    ...
    "proof.models.body": "Automatically fall back across Claude, OpenAI, and Google models when a provider is down or your credits run out. Enjoy the flexibility to route any job to any model from these three companies.",
  ...
  he: {
    ...
    "proof.models.body": "שמור על זמינות המערכת בזמן תקלות ספק או סיום הקרדיטים עם מעבר אוטומטי בין Claude, OpenAI ו-Google. כמו כן, עומד לרשותך החופש להפעיל כל מודל של שלוש החברות הללו עבור כל משימה שתצטרך.",

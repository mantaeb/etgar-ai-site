...
const translations = {
  en: {
    ...
    "founder.body": "",
    "founder.buildLink": "Behind the build",
    "founder.buildHref": "https://ai-build.bonar1.com/",
  ...
  he: {
    ...
    "intro.title": "לא עוד צ'אטבוט. מערכת אישית שעובדת איתך בכלים שלך.",
    ...
    "feature.memory.title": "זיכרון ארוך טווח הניתן לאימות ותיקון",
    "feature.memory.body": "העוזר בונה ומתחזק \"מוח שני\" שנוצר מתוך מסמכים, משימות, ורשומות. ניתן להתחקות אחר המקור של כל עובדה חשובה ולחדד את הזיכרונות במקור לשימוש חוזר מדויק.",
    ...
    "founder.body": "",
    "founder.buildLink": "מאחורי הבנייה",
    "founder.buildHref": "https://ai-build.bonar1.com/he/",

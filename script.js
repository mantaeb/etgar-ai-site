...
const translations = {
  en: {
    ...
    "proof.models.title": "Model-agnostic uptime",
    "proof.models.body": "Sequential fallback across Claude, OpenAI, and Google models to keep the system available when one provider is unavailable.",
  ...
  he: {
    ...
    "proof.models.title": "זמינות בין מודלים",
    "proof.models.body": "רצף גיבויים בין Claude, OpenAI ו-Google כדי שהמערכת תמשיך לעבוד גם כשספק או מודל לא זמין.",

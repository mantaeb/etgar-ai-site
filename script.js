...
const translations = {
  en: {
    ...
    "feature.control.body": "The system is built around clear permissions. Anything that enters long-term memory requires human approval, and control of the knowledge always stays with you.",
    ...
    "interest.body": "",
    "interest.cta": "Tell me about your needs",
  ...
  he: {
    ...
    "hero.lede": "לאנשים שלא מתפשרים על פרטיות ושליטה. ה-AI הפרטית שלך זוכרת, מסנכרנת ופועלת ברקע מסביב לשעון, כדי לנהל עבורך את החיים בצורה חכמה וחלקה.",
    ...
    "feature.control.body": "המערכת בנויה על הרשאות ברורות. כל מידע שנכנס לזיכרון ארוך-הטווח דורש אישור אנושי, והשליטה על הידע נשארת תמיד אצלך.",
    ...
    "interest.body": "",
    "interest.cta": "ספרו לי על הצרכים שלכם",
